  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-900 mb-6 sm:mb-8">Home</h1>
        
        {/* Conference Announcement */}
        <div className="bg-blue-50 border-l-4 border-blue-600 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8 shadow-md">
          <h2 className="text-xl sm:text-2xl font-bold text-blue-900 mb-3 sm:mb-4">2026 Precision Agriculture Technology Conference</h2>

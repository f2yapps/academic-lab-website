  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold text-blue-900 mb-8">Home</h1>
        
        {/* Conference Announcement */}
        <div className="bg-blue-50 border-l-4 border-blue-600 rounded-lg p-6 mb-8 shadow-md">
          <h2 className="text-2xl font-bold text-blue-900 mb-4">2026 Precision Agriculture Technology Conference</h2>
          <p className="text-lg text-gray-800 mb-2">
            <strong>Date:</strong> Thursday, February 26, 2026
          </p>
          <p className="text-lg text-gray-800">
            <strong>Location:</strong> Crowne Plaza, 173 Jennifer Rd, Annapolis
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-12">
          ...
          <div className="flex-1 max-w-none">
            ...
            <div className="mt-10 mb-8">
              <h2 className="text-2xl font-semibold text-blue-900 mb-4">Vision</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="bg-gray-100 rounded-lg p-6">
              ...
              {/* Office */}
              <div className="mt-8 pt-6 border-t border-gray-300">
                <h3 className="text-lg font-semibold text-blue-900 mb-4">OFFICE</h3>
        ...
        <div className="mt-10 mb-8 bg-gray-100 rounded-lg p-6 w-full">
          <h2 className="text-2xl font-semibold text-blue-900 mb-6">Our Latest Edited Books</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg p-4 hover:shadow-lg transition-shadow">
              <a href="#" target="_blank" rel="noopener noreferrer" className="block group">
                <Image
                  ...
                  width={200}
                  height={300}
                  className="rounded-lg w-full max-w-[200px] h-auto mx-auto group-hover:scale-105 transition-transform mb-4"
                  unoptimized
                />
              </a>
              <div className="text-center space-y-2">
                <h3 className="font-semibold text-gray-900">Precision Technologies for Digital Agriculture: Harnessing IoT, Big Data, Crop Modeling, and Al for Agricultural Production</h3>
            ...
            <div className="bg-white rounded-lg p-4 hover:shadow-lg transition-shadow">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-gray-700">
                  <span className="font-medium">Edited by:</span> Editor Name
                </p>
                <p className="text-sm text-gray-700">
                  <span className="font-medium">Publisher:</span> Publisher Name
                </p>
                <p className="text-sm text-gray-700">
                  <span className="font-medium">ISBN:</span> ISBN Number
                </p>
              </div>
            </div>
